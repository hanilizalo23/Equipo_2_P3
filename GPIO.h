...
/********************************************************************************************/
/*!
 	 \brief	 This function assigns the function for the interruption of a port.
 	 \param[in]  port_name Port to assign the handler.
 	 \param[in]  handler Pointer to the fucntion that is going to be assigned.
 	 \return void
 */
...
/********************************************************************************************/
/*!
 	 \brief	 This function clears the irq status of the GPIO.
 	 \param[in]  port_name Port to clear irq.
 	 \return void
 */
...
/********************************************************************************************/
/*!
 	 \brief	 This function reads the irq status of the GPIO.
 	 \param[in]  port_name Port to read irq.
 	 \return status of the irq.
 */
